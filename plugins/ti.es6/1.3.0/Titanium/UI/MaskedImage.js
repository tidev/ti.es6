...
export default class MaskedImage {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.MaskedImage')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createMaskedImage(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.MaskedImage.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.MaskedImage.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.MaskedImage.rect;
	}
	static get size () {
		return Titanium.UI.MaskedImage.size;
	}
	static get children () {
		return Titanium.UI.MaskedImage.children;
	}
	...
	get mask () {
		return this._object.mask;
	}
	set mask (value) {
		this._object.mask = value;
	}
	get image () {
	...
	get tint () {
		return this._object.tint;
	}
	set tint (value) {
		this._object.tint = value;
	}
	...
	getMask () {
		return this._object.getMask();
	}
	setMask (mask) {
		return this._object.setMask(mask);
	}
	getImage () {
	...
	getTint () {
		return this._object.getTint();
	}
	setTint (tint) {
		return this._object.setTint(tint);
	}

	// modules
};
Object.freeze(MaskedImage);
