...
export default class SplitWindow {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iPad.SplitWindow')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iPad.createSplitWindow(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iPad.SplitWindow.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iPad.SplitWindow.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iPad.SplitWindow.rect;
	}
	static get size () {
		return Titanium.UI.iPad.SplitWindow.size;
	}
	static get children () {
		return Titanium.UI.iPad.SplitWindow.children;
	}
	static get orientation () {
		return Titanium.UI.iPad.SplitWindow.orientation;
	}
