...
export default class Text {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.XML.Text')) {
			this._object = object;
		} else {
	...
	// constants
	static get apiName () {
		return Titanium.XML.Text.apiName;
	}
	static get ATTRIBUTE_NODE () {
		return Titanium.XML.Text.ATTRIBUTE_NODE;
	}
	static get CDATA_SECTION_NODE () {
		return Titanium.XML.Text.CDATA_SECTION_NODE;
	}
	static get COMMENT_NODE () {
		return Titanium.XML.Text.COMMENT_NODE;
	}
	static get DOCUMENT_FRAGMENT_NODE () {
		return Titanium.XML.Text.DOCUMENT_FRAGMENT_NODE;
	}
	static get DOCUMENT_NODE () {
		return Titanium.XML.Text.DOCUMENT_NODE;
	}
	static get DOCUMENT_TYPE_NODE () {
		return Titanium.XML.Text.DOCUMENT_TYPE_NODE;
	}
	static get ELEMENT_NODE () {
		return Titanium.XML.Text.ELEMENT_NODE;
	}
	static get ENTITY_NODE () {
		return Titanium.XML.Text.ENTITY_NODE;
	}
	static get ENTITY_REFERENCE_NODE () {
		return Titanium.XML.Text.ENTITY_REFERENCE_NODE;
	}
	static get NOTATION_NODE () {
		return Titanium.XML.Text.NOTATION_NODE;
	}
	static get PROCESSING_INSTRUCTION_NODE () {
		return Titanium.XML.Text.PROCESSING_INSTRUCTION_NODE;
	}
	static get TEXT_NODE () {
		return Titanium.XML.Text.TEXT_NODE;
	}
	static get nodeName () {
		return Titanium.XML.Text.nodeName;
	}
	static get nodeType () {
		return Titanium.XML.Text.nodeType;
	}
	static get parentNode () {
		return new Node(Titanium.XML.Text.parentNode);
	}
	static get childNodes () {
		return new NodeList(Titanium.XML.Text.childNodes);
	}
	static get firstChild () {
		return new Node(Titanium.XML.Text.firstChild);
	}
	static get lastChild () {
		return new Node(Titanium.XML.Text.lastChild);
	}
	static get previousSibling () {
		return new Node(Titanium.XML.Text.previousSibling);
	}
	static get nextSibling () {
		return new Node(Titanium.XML.Text.nextSibling);
	}
	static get attributes () {
		return new NamedNodeMap(Titanium.XML.Text.attributes);
	}
	static get ownerDocument () {
		return new Document(Titanium.XML.Text.ownerDocument);
	}
	static get namespaceURI () {
		return Titanium.XML.Text.namespaceURI;
	}
	static get text () {
		return Titanium.XML.Text.text;
	}
	static get textContent () {
		return Titanium.XML.Text.textContent;
	}
	static get length () {
		return Titanium.XML.Text.length;
	}
