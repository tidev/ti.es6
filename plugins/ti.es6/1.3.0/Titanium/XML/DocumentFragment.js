...
export default class DocumentFragment {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.XML.DocumentFragment')) {
			this._object = object;
		} else {
			this._object = Titanium.XML.Document.createDocumentFragment(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.XML.DocumentFragment.apiName;
	}
	static get ATTRIBUTE_NODE () {
		return Titanium.XML.DocumentFragment.ATTRIBUTE_NODE;
	}
	static get CDATA_SECTION_NODE () {
		return Titanium.XML.DocumentFragment.CDATA_SECTION_NODE;
	}
	static get COMMENT_NODE () {
		return Titanium.XML.DocumentFragment.COMMENT_NODE;
	}
	static get DOCUMENT_FRAGMENT_NODE () {
		return Titanium.XML.DocumentFragment.DOCUMENT_FRAGMENT_NODE;
	}
	static get DOCUMENT_NODE () {
		return Titanium.XML.DocumentFragment.DOCUMENT_NODE;
	}
	static get DOCUMENT_TYPE_NODE () {
		return Titanium.XML.DocumentFragment.DOCUMENT_TYPE_NODE;
	}
	static get ELEMENT_NODE () {
		return Titanium.XML.DocumentFragment.ELEMENT_NODE;
	}
	static get ENTITY_NODE () {
		return Titanium.XML.DocumentFragment.ENTITY_NODE;
	}
	static get ENTITY_REFERENCE_NODE () {
		return Titanium.XML.DocumentFragment.ENTITY_REFERENCE_NODE;
	}
	static get NOTATION_NODE () {
		return Titanium.XML.DocumentFragment.NOTATION_NODE;
	}
	static get PROCESSING_INSTRUCTION_NODE () {
		return Titanium.XML.DocumentFragment.PROCESSING_INSTRUCTION_NODE;
	}
	static get TEXT_NODE () {
		return Titanium.XML.DocumentFragment.TEXT_NODE;
	}
	static get nodeName () {
		return Titanium.XML.DocumentFragment.nodeName;
	}
	static get nodeType () {
		return Titanium.XML.DocumentFragment.nodeType;
	}
	static get parentNode () {
		return new Node(Titanium.XML.DocumentFragment.parentNode);
	}
	static get childNodes () {
		return new NodeList(Titanium.XML.DocumentFragment.childNodes);
	}
	static get firstChild () {
		return new Node(Titanium.XML.DocumentFragment.firstChild);
	}
	static get lastChild () {
		return new Node(Titanium.XML.DocumentFragment.lastChild);
	}
	static get previousSibling () {
		return new Node(Titanium.XML.DocumentFragment.previousSibling);
	}
	static get nextSibling () {
		return new Node(Titanium.XML.DocumentFragment.nextSibling);
	}
	static get attributes () {
		return new NamedNodeMap(Titanium.XML.DocumentFragment.attributes);
	}
	static get ownerDocument () {
		return new Document(Titanium.XML.DocumentFragment.ownerDocument);
	}
	static get namespaceURI () {
		return Titanium.XML.DocumentFragment.namespaceURI;
	}
	static get text () {
		return Titanium.XML.DocumentFragment.text;
	}
	static get textContent () {
		return Titanium.XML.DocumentFragment.textContent;
	}
...
Object.freeze(DocumentFragment);
