...
export default class Comment {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.XML.Comment')) {
			this._object = object;
		} else {
			this._object = Titanium.XML.Document.createComment(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.XML.Comment.apiName;
	}
	static get ATTRIBUTE_NODE () {
		return Titanium.XML.Comment.ATTRIBUTE_NODE;
	}
	static get CDATA_SECTION_NODE () {
		return Titanium.XML.Comment.CDATA_SECTION_NODE;
	}
	static get COMMENT_NODE () {
		return Titanium.XML.Comment.COMMENT_NODE;
	}
	static get DOCUMENT_FRAGMENT_NODE () {
		return Titanium.XML.Comment.DOCUMENT_FRAGMENT_NODE;
	}
	static get DOCUMENT_NODE () {
		return Titanium.XML.Comment.DOCUMENT_NODE;
	}
	static get DOCUMENT_TYPE_NODE () {
		return Titanium.XML.Comment.DOCUMENT_TYPE_NODE;
	}
	static get ELEMENT_NODE () {
		return Titanium.XML.Comment.ELEMENT_NODE;
	}
	static get ENTITY_NODE () {
		return Titanium.XML.Comment.ENTITY_NODE;
	}
	static get ENTITY_REFERENCE_NODE () {
		return Titanium.XML.Comment.ENTITY_REFERENCE_NODE;
	}
	static get NOTATION_NODE () {
		return Titanium.XML.Comment.NOTATION_NODE;
	}
	static get PROCESSING_INSTRUCTION_NODE () {
		return Titanium.XML.Comment.PROCESSING_INSTRUCTION_NODE;
	}
	static get TEXT_NODE () {
		return Titanium.XML.Comment.TEXT_NODE;
	}
	static get nodeName () {
		return Titanium.XML.Comment.nodeName;
	}
	static get nodeType () {
		return Titanium.XML.Comment.nodeType;
	}
	static get parentNode () {
		return new Node(Titanium.XML.Comment.parentNode);
	}
	static get childNodes () {
		return new NodeList(Titanium.XML.Comment.childNodes);
	}
	static get firstChild () {
		return new Node(Titanium.XML.Comment.firstChild);
	}
	static get lastChild () {
		return new Node(Titanium.XML.Comment.lastChild);
	}
	static get previousSibling () {
		return new Node(Titanium.XML.Comment.previousSibling);
	}
	static get nextSibling () {
		return new Node(Titanium.XML.Comment.nextSibling);
	}
	static get attributes () {
		return new NamedNodeMap(Titanium.XML.Comment.attributes);
	}
	static get ownerDocument () {
		return new Document(Titanium.XML.Comment.ownerDocument);
	}
	static get namespaceURI () {
		return Titanium.XML.Comment.namespaceURI;
	}
	static get text () {
		return Titanium.XML.Comment.text;
	}
	static get textContent () {
		return Titanium.XML.Comment.textContent;
	}
	static get length () {
		return Titanium.XML.Comment.length;
	}
