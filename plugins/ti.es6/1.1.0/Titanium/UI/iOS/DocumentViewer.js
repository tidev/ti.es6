...
export default class DocumentViewer {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.DocumentViewer')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createDocumentViewer(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.DocumentViewer.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.DocumentViewer.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.DocumentViewer.rect;
	}
	static get size () {
		return Titanium.UI.iOS.DocumentViewer.size;
	}
	static get children () {
		return Titanium.UI.iOS.DocumentViewer.children;
	}
	static get name () {
		return Titanium.UI.iOS.DocumentViewer.name;
	}
