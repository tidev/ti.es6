...
export default class Stepper {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.Stepper')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createStepper(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.Stepper.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.Stepper.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.Stepper.rect;
	}
	static get size () {
		return Titanium.UI.iOS.Stepper.size;
	}
	static get children () {
		return Titanium.UI.iOS.Stepper.children;
	}
	...
	get continuous () {
		return this._object.continuous;
	}
	set continuous (value) {
		this._object.continuous = value;
	}
	get autorepeat () {
		return this._object.autorepeat;
	}
	set autorepeat (value) {
		this._object.autorepeat = value;
	}
	get wraps () {
		return this._object.wraps;
	}
	set wraps (value) {
		this._object.wraps = value;
	}
	get minimum () {
		return this._object.minimum;
	}
	set minimum (value) {
		this._object.minimum = value;
	}
	get maximum () {
		return this._object.maximum;
	}
	set maximum (value) {
		this._object.maximum = value;
	}
	get steps () {
		return this._object.steps;
	}
	set steps (value) {
		this._object.steps = value;
	}
	get decrementImage () {
		return this._object.decrementImage;
	}
	set decrementImage (value) {
		this._object.decrementImage = value;
	}
	get decrementDisabledImage () {
		return this._object.decrementDisabledImage;
	}
	set decrementDisabledImage (value) {
		this._object.decrementDisabledImage = value;
	}
	get incrementImage () {
		return this._object.incrementImage;
	}
	set incrementImage (value) {
		this._object.incrementImage = value;
	}
	get incrementDisabledImage () {
		return this._object.incrementDisabledImage;
	}
	set incrementDisabledImage (value) {
		this._object.incrementDisabledImage = value;
	}
	...
	getContinuous () {
		return this._object.getContinuous();
	}
	setContinuous (continuous) {
		return this._object.setContinuous(continuous);
	}
	getAutorepeat () {
		return this._object.getAutorepeat();
	}
	setAutorepeat (autorepeat) {
		return this._object.setAutorepeat(autorepeat);
	}
	getWraps () {
		return this._object.getWraps();
	}
	setWraps (wraps) {
		return this._object.setWraps(wraps);
	}
	getMinimum () {
		return this._object.getMinimum();
	}
	setMinimum (minimum) {
		return this._object.setMinimum(minimum);
	}
	getMaximum () {
		return this._object.getMaximum();
	}
	setMaximum (maximum) {
		return this._object.setMaximum(maximum);
	}
	getSteps () {
		return this._object.getSteps();
	}
	setSteps (steps) {
		return this._object.setSteps(steps);
	}
	getDecrementImage () {
		return this._object.getDecrementImage();
	}
	setDecrementImage (decrementImage) {
		return this._object.setDecrementImage(decrementImage);
	}
	getDecrementDisabledImage () {
		return this._object.getDecrementDisabledImage();
	}
	setDecrementDisabledImage (decrementDisabledImage) {
		return this._object.setDecrementDisabledImage(decrementDisabledImage);
	}
	getIncrementImage () {
		return this._object.getIncrementImage();
	}
	setIncrementImage (incrementImage) {
		return this._object.setIncrementImage(incrementImage);
	}
	getIncrementDisabledImage () {
		return this._object.getIncrementDisabledImage();
	}
	setIncrementDisabledImage (incrementDisabledImage) {
		return this._object.setIncrementDisabledImage(incrementDisabledImage);
	}
