...
export default class BlurView {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.BlurView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createBlurView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.BlurView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.BlurView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.BlurView.rect;
	}
	static get size () {
		return Titanium.UI.iOS.BlurView.size;
	}
	static get children () {
		return Titanium.UI.iOS.BlurView.children;
	}
	...
	get effect () {
		return this._object.effect;
	}
	set effect (value) {
		this._object.effect = value;
	}
	...
	getEffect () {
		return this._object.getEffect();
	}
	setEffect (effect) {
		return this._object.setEffect(effect);
	}

	// modules
};
Object.freeze(BlurView);
