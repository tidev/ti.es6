...
export default class View {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.Map.View')) {
			this._object = object;
		} else {
			this._object = Titanium.Map.createView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.Map.View.apiName;
	}
	static get animatedCenter () {
		return Titanium.Map.View.animatedCenter;
	}
	static get rect () {
		return Titanium.Map.View.rect;
	}
	static get size () {
		return Titanium.Map.View.size;
	}
	static get children () {
		return Titanium.Map.View.children;
	}
	static get latitudeDelta () {
		return Titanium.Map.View.latitudeDelta;
	}
	static get longitudeDelta () {
		return Titanium.Map.View.longitudeDelta;
	}
	...
	get hideAnnotationWhenTouchMap () {
		return this._object.hideAnnotationWhenTouchMap;
	}
	set hideAnnotationWhenTouchMap (value) {
		this._object.hideAnnotationWhenTouchMap = value;
	}
	get regionFit () {
		return this._object.regionFit;
	}
	set regionFit (value) {
		this._object.regionFit = value;
	}
	get latitudeDelta () {
		return this._object.latitudeDelta;
	}
	get longitudeDelta () {
		return this._object.longitudeDelta;
	}
	get animate () {
	...
	get annotations () {
		return this._object.annotations;
	}
	set annotations (value) {
		this._object.annotations = value;
	}
	get mapType () {
		return this._object.mapType;
	}
	set mapType (value) {
		this._object.mapType = value;
	}
	get region () {
		return this._object.region;
	}
	set region (value) {
		this._object.region = value;
	}
	get userLocation () {
		return this._object.userLocation;
	}
	set userLocation (value) {
		this._object.userLocation = value;
	}
	...
	addRoute (route) {
		return this._object.addRoute(route);
	}
	deselectAnnotation (annotation) {
		return this._object.deselectAnnotation(annotation);
	}
	removeRoute (route) {
		return this._object.removeRoute(route);
	}
	selectAnnotation (annotation) {
		return this._object.selectAnnotation(annotation);
	}
	...
	addAnnotation (annotation) {
		...
		return this._object.addAnnotation(annotation);
	}
	addAnnotations (annotations) {
		return this._object.addAnnotations(annotations);
	}
	removeAllAnnotations () {
		return this._object.removeAllAnnotations();
	}
	removeAnnotation (annotation) {
		return this._object.removeAnnotation(annotation);
	}
	removeAnnotations (annotations) {
		return this._object.removeAnnotations(annotations);
	}
	zoom (level) {
		return this._object.zoom(level);
	}
	setMapType (mapType) {
		return this._object.setMapType(mapType);
	}
	getApiName () {
	...
	getHideAnnotationWhenTouchMap () {
		return this._object.getHideAnnotationWhenTouchMap();
	}
	setHideAnnotationWhenTouchMap (hideAnnotationWhenTouchMap) {
		return this._object.setHideAnnotationWhenTouchMap(hideAnnotationWhenTouchMap);
	}
	getRegionFit () {
		return this._object.getRegionFit();
	}
	setRegionFit (regionFit) {
		return this._object.setRegionFit(regionFit);
	}
	getLatitudeDelta () {
		return this._object.getLatitudeDelta();
	}
	getLongitudeDelta () {
		return this._object.getLongitudeDelta();
	}
	getAnimate () {
	...
	getAnnotations () {
		return this._object.getAnnotations();
	}
	setAnnotations (annotations) {
		return this._object.setAnnotations(annotations);
	}
	getMapType () {
		return this._object.getMapType();
	}
	setMapType (mapType) {
		return this._object.setMapType(mapType);
	}
	getRegion () {
		return this._object.getRegion();
	}
	setRegion (region) {
		return this._object.setRegion(region);
	}
	getUserLocation () {
		return this._object.getUserLocation();
	}
	setUserLocation (userLocation) {
		return this._object.setUserLocation(userLocation);
	}
