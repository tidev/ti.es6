...
export default class Button {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.Button')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createButton(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.Button.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.Button.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.Button.rect;
	}
	static get size () {
		return Titanium.UI.Button.size;
	}
	static get children () {
		return Titanium.UI.Button.children;
	}
	...
	get disabledColor () {
		return this._object.disabledColor;
	}
	set disabledColor (value) {
		this._object.disabledColor = value;
	}
	get enabled () {
	...
	get systemButton () {
		return this._object.systemButton;
	}
	set systemButton (value) {
		this._object.systemButton = value;
	}
	get color () {
	...
	getDisabledColor () {
		return this._object.getDisabledColor();
	}
	setDisabledColor (disabledColor) {
		return this._object.setDisabledColor(disabledColor);
	}
	getEnabled () {
	...
	getSystemButton () {
		return this._object.getSystemButton();
	}
	setSystemButton (systemButton) {
		return this._object.setSystemButton(systemButton);
	}
	getColor () {
