...
export default class ImageView {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.ImageView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createImageView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.ImageView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.ImageView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.ImageView.rect;
	}
	static get size () {
		return Titanium.UI.ImageView.size;
	}
	static get children () {
		return Titanium.UI.ImageView.children;
	}
	static get animating () {
		return Titanium.UI.ImageView.animating;
	}
	static get paused () {
		return Titanium.UI.ImageView.paused;
	}
	...
	get autorotate () {
		return this._object.autorotate;
	}
	set autorotate (value) {
		this._object.autorotate = value;
	}
	get decodeRetries () {
	...
	get hires () {
		return this._object.hires;
	}
	set hires (value) {
		this._object.hires = value;
	}
	get preventDefaultImage () {
		return this._object.preventDefaultImage;
	}
	set preventDefaultImage (value) {
		this._object.preventDefaultImage = value;
	}
	get url () {
	...
	get animating () {
		return this._object.animating;
	}
	get defaultImage () {
		return this._object.defaultImage;
	}
	set defaultImage (value) {
		this._object.defaultImage = value;
	}
	get duration () {
	...
	get images () {
		return this._object.images;
	}
	set images (value) {
		this._object.images = value;
	}
	get paused () {
		return this._object.paused;
	}
	get repeatCount () {
		return this._object.repeatCount;
	}
	set repeatCount (value) {
		this._object.repeatCount = value;
	}
	get reverse () {
		return this._object.reverse;
	}
	set reverse (value) {
		this._object.reverse = value;
	}
	...
	getAutorotate () {
		return this._object.getAutorotate();
	}
	setAutorotate (autorotate) {
		return this._object.setAutorotate(autorotate);
	}
	getDecodeRetries () {
	...
	getHires () {
		return this._object.getHires();
	}
	setHires (hires) {
		return this._object.setHires(hires);
	}
	getPreventDefaultImage () {
		return this._object.getPreventDefaultImage();
	}
	setPreventDefaultImage (preventDefaultImage) {
		return this._object.setPreventDefaultImage(preventDefaultImage);
	}
	getUrl () {
	...
	getAnimating () {
		return this._object.getAnimating();
	}
	getDefaultImage () {
		return this._object.getDefaultImage();
	}
	setDefaultImage (defImage) {
		return this._object.setDefaultImage(defImage);
	}
	getDuration () {
	...
	getImages () {
		return this._object.getImages();
	}
	setImages (images) {
		return this._object.setImages(images);
	}
	getPaused () {
		return this._object.getPaused();
	}
	getRepeatCount () {
		return this._object.getRepeatCount();
	}
	setRepeatCount (repeatCount) {
		return this._object.setRepeatCount(repeatCount);
	}
	getReverse () {
		return this._object.getReverse();
	}
	setReverse (reverse) {
		return this._object.setReverse(reverse);
	}

	// modules
};
Object.freeze(ImageView);
