...
export default class Label {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.Label')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createLabel(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.Label.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.Label.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.Label.rect;
	}
	static get size () {
		return Titanium.UI.Label.size;
	}
	static get children () {
		return Titanium.UI.Label.children;
	}
	...
	get backgroundPaddingBottom () {
		return this._object.backgroundPaddingBottom;
	}
	set backgroundPaddingBottom (value) {
		this._object.backgroundPaddingBottom = value;
	}
	get backgroundPaddingLeft () {
		return this._object.backgroundPaddingLeft;
	}
	set backgroundPaddingLeft (value) {
		this._object.backgroundPaddingLeft = value;
	}
	get backgroundPaddingRight () {
		return this._object.backgroundPaddingRight;
	}
	set backgroundPaddingRight (value) {
		this._object.backgroundPaddingRight = value;
	}
	get backgroundPaddingTop () {
		return this._object.backgroundPaddingTop;
	}
	set backgroundPaddingTop (value) {
		this._object.backgroundPaddingTop = value;
	}
	get ellipsize () {
	...
	get highlightedColor () {
		return this._object.highlightedColor;
	}
	set highlightedColor (value) {
		this._object.highlightedColor = value;
	}
	get html () {
	...
	get includeFontPadding () {
		return this._object.includeFontPadding;
	}
	set includeFontPadding (value) {
		this._object.includeFontPadding = value;
	}
	get lines () {
		return this._object.lines;
	}
	set lines (value) {
		this._object.lines = value;
	}
	get lineSpacing () {
		return this._object.lineSpacing;
	}
	set lineSpacing (value) {
		this._object.lineSpacing = value;
	}
	get maxLines () {
		return this._object.maxLines;
	}
	set maxLines (value) {
		this._object.maxLines = value;
	}
	get minimumFontSize () {
	...
	get shadowColor () {
		return this._object.shadowColor;
	}
	set shadowColor (value) {
		this._object.shadowColor = value;
	}
	get shadowOffset () {
		return this._object.shadowOffset;
	}
	set shadowOffset (value) {
		this._object.shadowOffset = value;
	}
	get shadowRadius () {
		return this._object.shadowRadius;
	}
	set shadowRadius (value) {
		this._object.shadowRadius = value;
	}
	get autoLink () {
	...
	get textid () {
		return this._object.textid;
	}
	set textid (value) {
		this._object.textid = value;
	}
	get text () {
	...
	get wordWrap () {
		return this._object.wordWrap;
	}
	set wordWrap (value) {
		this._object.wordWrap = value;
	}
	...
	getBackgroundPaddingBottom () {
		return this._object.getBackgroundPaddingBottom();
	}
	setBackgroundPaddingBottom (backgroundPaddingBottom) {
		return this._object.setBackgroundPaddingBottom(backgroundPaddingBottom);
	}
	getBackgroundPaddingLeft () {
		return this._object.getBackgroundPaddingLeft();
	}
	setBackgroundPaddingLeft (backgroundPaddingLeft) {
		return this._object.setBackgroundPaddingLeft(backgroundPaddingLeft);
	}
	getBackgroundPaddingRight () {
		return this._object.getBackgroundPaddingRight();
	}
	setBackgroundPaddingRight (backgroundPaddingRight) {
		return this._object.setBackgroundPaddingRight(backgroundPaddingRight);
	}
	getBackgroundPaddingTop () {
		return this._object.getBackgroundPaddingTop();
	}
	setBackgroundPaddingTop (backgroundPaddingTop) {
		return this._object.setBackgroundPaddingTop(backgroundPaddingTop);
	}
	getEllipsize () {
	...
	getHighlightedColor () {
		return this._object.getHighlightedColor();
	}
	setHighlightedColor (highlightedColor) {
		return this._object.setHighlightedColor(highlightedColor);
	}
	getHtml () {
	...
	getIncludeFontPadding () {
		return this._object.getIncludeFontPadding();
	}
	setIncludeFontPadding (includeFontPadding) {
		return this._object.setIncludeFontPadding(includeFontPadding);
	}
	getLines () {
		return this._object.getLines();
	}
	setLines (lines) {
		return this._object.setLines(lines);
	}
	getLineSpacing () {
		return this._object.getLineSpacing();
	}
	setLineSpacing (lineSpacing) {
		lineSpacing = normalize(lineSpacing);
		return this._object.setLineSpacing(lineSpacing);
	}
	getMaxLines () {
		return this._object.getMaxLines();
	}
	setMaxLines (maxLines) {
		return this._object.setMaxLines(maxLines);
	}
	getMinimumFontSize () {
	...
	getShadowColor () {
		return this._object.getShadowColor();
	}
	setShadowColor (shadowColor) {
		return this._object.setShadowColor(shadowColor);
	}
	getShadowOffset () {
		return this._object.getShadowOffset();
	}
	setShadowOffset (shadowOffset) {
		shadowOffset = normalize(shadowOffset);
		return this._object.setShadowOffset(shadowOffset);
	}
	getShadowRadius () {
		return this._object.getShadowRadius();
	}
	setShadowRadius (shadowRadius) {
		return this._object.setShadowRadius(shadowRadius);
	}
	getAutoLink () {
	...
	getTextid () {
		return this._object.getTextid();
	}
	setTextid (textid) {
		return this._object.setTextid(textid);
	}
	getText () {
	...
	getWordWrap () {
		return this._object.getWordWrap();
	}
	setWordWrap (wordWrap) {
		return this._object.setWordWrap(wordWrap);
	}
	getAttributedString () {
