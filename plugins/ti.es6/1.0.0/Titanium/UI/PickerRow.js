...
export default class PickerRow {

	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.PickerRow')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createPickerRow(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.PickerRow.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.PickerRow.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.PickerRow.rect;
	}
	static get size () {
		return Titanium.UI.PickerRow.size;
	}
	static get children () {
		return Titanium.UI.PickerRow.children;
	}
