...
export default class ActivityIndicator {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.ActivityIndicator')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createActivityIndicator(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.ActivityIndicator.apiName;
	}
	...
	get indicatorColor () {
		return this._object.indicatorColor;
	}
	set indicatorColor (value) {
		this._object.indicatorColor = value;
	}
	...
	getIndicatorColor () {
		return this._object.getIndicatorColor();
	}
	setIndicatorColor (indicatorColor) {
		return this._object.setIndicatorColor(indicatorColor);
	}

	// modules
};
Object.freeze(ActivityIndicator);
