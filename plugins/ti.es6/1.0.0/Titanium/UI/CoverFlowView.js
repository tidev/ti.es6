...
export default class CoverFlowView {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.CoverFlowView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createCoverFlowView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.CoverFlowView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.CoverFlowView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.CoverFlowView.rect;
	}
	static get size () {
		return Titanium.UI.CoverFlowView.size;
	}
	static get children () {
		return Titanium.UI.CoverFlowView.children;
	}
