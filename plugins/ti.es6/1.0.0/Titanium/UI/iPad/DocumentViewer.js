...
export default class DocumentViewer {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iPad.DocumentViewer')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iPad.createDocumentViewer(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iPad.DocumentViewer.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iPad.DocumentViewer.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iPad.DocumentViewer.rect;
	}
	static get size () {
		return Titanium.UI.iPad.DocumentViewer.size;
	}
	static get children () {
		return Titanium.UI.iPad.DocumentViewer.children;
	}
	...
	show (animated, view) {
		view = normalize(view);
		return this._object.show(animated, view);
	}
	getViewById (id) {
