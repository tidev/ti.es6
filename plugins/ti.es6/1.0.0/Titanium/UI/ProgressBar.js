...
export default class ProgressBar {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.ProgressBar')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createProgressBar(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.ProgressBar.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.ProgressBar.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.ProgressBar.rect;
	}
	static get size () {
		return Titanium.UI.ProgressBar.size;
	}
	static get children () {
		return Titanium.UI.ProgressBar.children;
	}
	...
	get trackTintColor () {
		return this._object.trackTintColor;
	}
	set trackTintColor (value) {
		this._object.trackTintColor = value;
	}
	get value () {
	...
	getTrackTintColor () {
		return this._object.getTrackTintColor();
	}
	setTrackTintColor (trackTintColor) {
		return this._object.setTrackTintColor(trackTintColor);
	}
	getValue () {
