...
export default class Toolbar {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.Toolbar')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createToolbar(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.Toolbar.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.Toolbar.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.Toolbar.rect;
	}
	static get size () {
		return Titanium.UI.iOS.Toolbar.size;
	}
	static get children () {
		return Titanium.UI.iOS.Toolbar.children;
	}
	...
	getExtendBackground () {
		return this._object.getExtendBackground();
	}
	setExtendBackground (extendBackground) {
		return this._object.setExtendBackground(extendBackground);
	}
	getTranslucent () {
