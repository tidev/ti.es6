...
export default class AdView {

	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.AdView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createAdView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.AdView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.AdView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.AdView.rect;
	}
	static get size () {
		return Titanium.UI.iOS.AdView.size;
	}
	static get children () {
		return Titanium.UI.iOS.AdView.children;
	}
	...
	get adSize () {
		return this._object.adSize;
	}
	set adSize (value) {
		this._object.adSize = value;
	}
	...
	cancelAction () {
		return this._object.cancelAction();
	}
	getApiName () {
	...
	getAdSize () {
		return this._object.getAdSize();
	}
	setAdSize (adSize) {
		return this._object.setAdSize(adSize);
	}

	// modules
};
Object.freeze(AdView);
