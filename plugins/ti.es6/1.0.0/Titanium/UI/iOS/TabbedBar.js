...
export default class TabbedBar {

	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.TabbedBar')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createTabbedBar(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.TabbedBar.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.TabbedBar.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.TabbedBar.rect;
	}
	static get size () {
		return Titanium.UI.iOS.TabbedBar.size;
	}
	static get children () {
		return Titanium.UI.iOS.TabbedBar.children;
	}
	...
	get labels () {
		return this._object.labels;
	}
	set labels (value) {
		this._object.labels = value;
	}
	get style () {
	...
	getLabels () {
		return this._object.getLabels();
	}
	setLabels (labels) {
		return this._object.setLabels(labels);
	}
	getStyle () {
