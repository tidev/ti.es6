export default class _3DMatrix {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.3DMatrix')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.create3DMatrix(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS._3DMatrix.apiName;
	}
