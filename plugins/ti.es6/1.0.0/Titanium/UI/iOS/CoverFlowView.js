...
export default class CoverFlowView {

	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.CoverFlowView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createCoverFlowView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.CoverFlowView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.CoverFlowView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.CoverFlowView.rect;
	}
	static get size () {
		return Titanium.UI.iOS.CoverFlowView.size;
	}
	static get children () {
		return Titanium.UI.iOS.CoverFlowView.children;
	}
	...
	setImage (index, image) {
		return this._object.setImage(index, image);
	}
	getApiName () {
	...
	setSelected (selected) {
		return this._object.setSelected(selected);
	}

	// modules
};
Object.freeze(CoverFlowView);
