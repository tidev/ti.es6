...
export default class ScrollableView {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.ScrollableView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createScrollableView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.ScrollableView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.ScrollableView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.ScrollableView.rect;
	}
	static get size () {
		return Titanium.UI.ScrollableView.size;
	}
	static get children () {
		return Titanium.UI.ScrollableView.children;
	}
	...
	get cacheSize () {
		return this._object.cacheSize;
	}
	set cacheSize (value) {
		this._object.cacheSize = value;
	}
	get currentPageIndicatorColor () {
		return this._object.currentPageIndicatorColor;
	}
	set currentPageIndicatorColor (value) {
		this._object.currentPageIndicatorColor = value;
	}
	get disableBounce () {
	...
	get pagingControlColor () {
		return this._object.pagingControlColor;
	}
	set pagingControlColor (value) {
		this._object.pagingControlColor = value;
	}
	get pagingControlHeight () {
		return this._object.pagingControlHeight;
	}
	set pagingControlHeight (value) {
		this._object.pagingControlHeight = value;
	}
	get pageIndicatorColor () {
		return this._object.pageIndicatorColor;
	}
	set pageIndicatorColor (value) {
		this._object.pageIndicatorColor = value;
	}
	get showPagingControl () {
		return this._object.showPagingControl;
	}
	set showPagingControl (value) {
		this._object.showPagingControl = value;
	}
	get pagingControlTimeout () {
		return this._object.pagingControlTimeout;
	}
	set pagingControlTimeout (value) {
		this._object.pagingControlTimeout = value;
	}
	get pagingControlAlpha () {
		return this._object.pagingControlAlpha;
	}
	set pagingControlAlpha (value) {
		this._object.pagingControlAlpha = value;
	}
	get pagingControlOnTop () {
		return this._object.pagingControlOnTop;
	}
	set pagingControlOnTop (value) {
		this._object.pagingControlOnTop = value;
	}
	get overlayEnabled () {
		return this._object.overlayEnabled;
	}
	set overlayEnabled (value) {
		this._object.overlayEnabled = value;
	}
	get clipViews () {
		return this._object.clipViews;
	}
	set clipViews (value) {
		this._object.clipViews = value;
	}
	get hitRect () {
		return this._object.hitRect;
	}
	set hitRect (value) {
		this._object.hitRect = value;
	}
	get currentPage () {
		return this._object.currentPage;
	}
	set currentPage (value) {
		this._object.currentPage = value;
	}
	...
	get views () {
		return this._object.views;
	}
	set views (value) {
		this._object.views = value;
	}
	...
	insertViewsAt (position, views) {
		return this._object.insertViewsAt(position, views);
	}
	addView (view) {
		view = normalize(view);
		return this._object.addView(view);
	}
	moveNext () {
		return this._object.moveNext();
	}
	movePrevious () {
		return this._object.movePrevious();
	}
	removeView (view) {
		return this._object.removeView(view);
	}
	scrollToView (view) {
		return this._object.scrollToView(view);
	}
	getApiName () {
	...
	getCacheSize () {
		return this._object.getCacheSize();
	}
	setCacheSize (cacheSize) {
		return this._object.setCacheSize(cacheSize);
	}
	getCurrentPageIndicatorColor () {
		return this._object.getCurrentPageIndicatorColor();
	}
	setCurrentPageIndicatorColor (currentPageIndicatorColor) {
		return this._object.setCurrentPageIndicatorColor(currentPageIndicatorColor);
	}
	getDisableBounce () {
	...
	getPagingControlColor () {
		return this._object.getPagingControlColor();
	}
	setPagingControlColor (pagingControlColor) {
		return this._object.setPagingControlColor(pagingControlColor);
	}
	getPagingControlHeight () {
		return this._object.getPagingControlHeight();
	}
	setPagingControlHeight (pagingControlHeight) {
		return this._object.setPagingControlHeight(pagingControlHeight);
	}
	getPageIndicatorColor () {
		return this._object.getPageIndicatorColor();
	}
	setPageIndicatorColor (pageIndicatorColor) {
		return this._object.setPageIndicatorColor(pageIndicatorColor);
	}
	getShowPagingControl () {
		return this._object.getShowPagingControl();
	}
	setShowPagingControl (showPagingControl) {
		return this._object.setShowPagingControl(showPagingControl);
	}
	getPagingControlTimeout () {
		return this._object.getPagingControlTimeout();
	}
	setPagingControlTimeout (pagingControlTimeout) {
		return this._object.setPagingControlTimeout(pagingControlTimeout);
	}
	getPagingControlAlpha () {
		return this._object.getPagingControlAlpha();
	}
	setPagingControlAlpha (pagingControlAlpha) {
		return this._object.setPagingControlAlpha(pagingControlAlpha);
	}
	getPagingControlOnTop () {
		return this._object.getPagingControlOnTop();
	}
	setPagingControlOnTop (pagingControlOnTop) {
		return this._object.setPagingControlOnTop(pagingControlOnTop);
	}
	getOverlayEnabled () {
		return this._object.getOverlayEnabled();
	}
	setOverlayEnabled (overlayEnabled) {
		return this._object.setOverlayEnabled(overlayEnabled);
	}
	getClipViews () {
		return this._object.getClipViews();
	}
	setClipViews (clipViews) {
		return this._object.setClipViews(clipViews);
	}
	getHitRect () {
		return this._object.getHitRect();
	}
	setHitRect (hitRect) {
		return this._object.setHitRect(hitRect);
	}
	getCurrentPage () {
		return this._object.getCurrentPage();
	}
	setCurrentPage (currentPage) {
		return this._object.setCurrentPage(currentPage);
	}
	getScrollingEnabled () {
	...
	getViews () {
		return this._object.getViews();
	}
	setViews (views) {
		return this._object.setViews(views);
	}

	// modules
};
Object.freeze(ScrollableView);
