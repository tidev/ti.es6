...
export default class SearchView {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.Android.SearchView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.Android.createSearchView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.Android.SearchView.apiName;
	}
	static get rect () {
		return Titanium.UI.Android.SearchView.rect;
	}
	static get size () {
		return Titanium.UI.Android.SearchView.size;
	}
	static get children () {
		return Titanium.UI.Android.SearchView.children;
	}
	...
	get iconified () {
		return this._object.iconified;
	}
	set iconified (value) {
		this._object.iconified = value;
	}
	get iconifiedByDefault () {
		return this._object.iconifiedByDefault;
	}
	set iconifiedByDefault (value) {
		this._object.iconifiedByDefault = value;
	}
	get submitEnabled () {
		return this._object.submitEnabled;
	}
	set submitEnabled (value) {
		this._object.submitEnabled = value;
	}
	...
	getIconified () {
		return this._object.getIconified();
	}
	setIconified (iconified) {
		return this._object.setIconified(iconified);
	}
	getIconifiedByDefault () {
		return this._object.getIconifiedByDefault();
	}
	setIconifiedByDefault (iconifiedByDefault) {
		return this._object.setIconifiedByDefault(iconifiedByDefault);
	}
	getSubmitEnabled () {
		return this._object.getSubmitEnabled();
	}
	setSubmitEnabled (submitEnabled) {
		return this._object.setSubmitEnabled(submitEnabled);
	}

	// modules
};
Object.freeze(SearchView);
