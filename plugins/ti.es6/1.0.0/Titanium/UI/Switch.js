...
export default class Switch {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.Switch')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createSwitch(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.Switch.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.Switch.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.Switch.rect;
	}
	static get size () {
		return Titanium.UI.Switch.size;
	}
	static get children () {
		return Titanium.UI.Switch.children;
	}
	...
	get animated () {
		return this._object.animated;
	}
	set animated (value) {
		this._object.animated = value;
	}
	get font () {
	...
	get onTintColor () {
		return this._object.onTintColor;
	}
	set onTintColor (value) {
		this._object.onTintColor = value;
	}
	get thumbTintColor () {
		return this._object.thumbTintColor;
	}
	set thumbTintColor (value) {
		this._object.thumbTintColor = value;
	}
	get verticalAlign () {
	...
	get titleOff () {
		return this._object.titleOff;
	}
	set titleOff (value) {
		this._object.titleOff = value;
	}
	get titleOn () {
		return this._object.titleOn;
	}
	set titleOn (value) {
		this._object.titleOn = value;
	}
	get value () {
	...
	getAnimated () {
		return this._object.getAnimated();
	}
	setAnimated (animated) {
		return this._object.setAnimated(animated);
	}
	getFont () {
	...
	getOnTintColor () {
		return this._object.getOnTintColor();
	}
	setOnTintColor (onTintColor) {
		return this._object.setOnTintColor(onTintColor);
	}
	getThumbTintColor () {
		return this._object.getThumbTintColor();
	}
	setThumbTintColor (thumbTintColor) {
		return this._object.setThumbTintColor(thumbTintColor);
	}
	getVerticalAlign () {
	...
	getTitleOff () {
		return this._object.getTitleOff();
	}
	setTitleOff (titleOff) {
		return this._object.setTitleOff(titleOff);
	}
	getTitleOn () {
		return this._object.getTitleOn();
	}
	setTitleOn (titleOn) {
		return this._object.setTitleOn(titleOn);
	}
	getValue () {
