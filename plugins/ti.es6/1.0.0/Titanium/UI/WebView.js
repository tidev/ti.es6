...
export default class WebView {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.WebView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createWebView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.WebView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.WebView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.WebView.rect;
	}
	static get size () {
		return Titanium.UI.WebView.size;
	}
	static get children () {
		return Titanium.UI.WebView.children;
	}
	...
	get allowsLinkPreview () {
		return this._object.allowsLinkPreview;
	}
	set allowsLinkPreview (value) {
		this._object.allowsLinkPreview = value;
	}
	get blacklistedURLs () {
		return this._object.blacklistedURLs;
	}
	set blacklistedURLs (value) {
		this._object.blacklistedURLs = value;
	}
	get disableBounce () {
	...
	get disableContextMenu () {
		return this._object.disableContextMenu;
	}
	set disableContextMenu (value) {
		this._object.disableContextMenu = value;
	}
	get enableJavascriptInterface () {
		return this._object.enableJavascriptInterface;
	}
	set enableJavascriptInterface (value) {
		this._object.enableJavascriptInterface = value;
	}
	get handlePlatformUrl () {
		return this._object.handlePlatformUrl;
	}
	set handlePlatformUrl (value) {
		this._object.handlePlatformUrl = value;
	}
	get hideLoadIndicator () {
		return this._object.hideLoadIndicator;
	}
	set hideLoadIndicator (value) {
		this._object.hideLoadIndicator = value;
	}
	get keyboardDisplayRequiresUserAction () {
		return this._object.keyboardDisplayRequiresUserAction;
	}
	set keyboardDisplayRequiresUserAction (value) {
		this._object.keyboardDisplayRequiresUserAction = value;
	}
	get ignoreSslError () {
		return this._object.ignoreSslError;
	}
	set ignoreSslError (value) {
		this._object.ignoreSslError = value;
	}
	get onCreateWindow () {
		return this._object.onCreateWindow;
	}
	set onCreateWindow (value) {
		this._object.onCreateWindow = value;
	}
	get overScrollMode () {
	...
	get cacheMode () {
		return this._object.cacheMode;
	}
	set cacheMode (value) {
		this._object.cacheMode = value;
	}
	get pluginState () {
		return this._object.pluginState;
	}
	set pluginState (value) {
		this._object.pluginState = value;
	}
	get scrollsToTop () {
	...
	get enableZoomControls () {
		return this._object.enableZoomControls;
	}
	set enableZoomControls (value) {
		this._object.enableZoomControls = value;
	}
	get scalesPageToFit () {
		return this._object.scalesPageToFit;
	}
	set scalesPageToFit (value) {
		this._object.scalesPageToFit = value;
	}
	get userAgent () {
	...
	get willHandleTouches () {
		return this._object.willHandleTouches;
	}
	set willHandleTouches (value) {
		this._object.willHandleTouches = value;
	}
	get lightTouchEnabled () {
		return this._object.lightTouchEnabled;
	}
	set lightTouchEnabled (value) {
		this._object.lightTouchEnabled = value;
	}
	get requestHeaders () {
		return this._object.requestHeaders;
	}
	set requestHeaders (value) {
		this._object.requestHeaders = value;
	}
	get data () {
		return new Blob(this._object.data);
	}
	set data (value) {
	...
	setBasicAuthentication (username, password) {
		return this._object.setBasicAuthentication(username, password);
	}
	canGoBack () {
		return this._object.canGoBack();
	}
	canGoForward () {
		return this._object.canGoForward();
	}
	evalJS (code) {
		return this._object.evalJS(code);
	}
	goBack () {
		return this._object.goBack();
	}
	goForward () {
		return this._object.goForward();
	}
	reload () {
		return this._object.reload();
	}
	stopLoading () {
		return this._object.stopLoading();
	}
	setHtml (html, options) {
		html = normalize(html);
		options = normalize(options);
		return this._object.setHtml(html, options);
	}
	getApiName () {
	...
	getAllowsLinkPreview () {
		return this._object.getAllowsLinkPreview();
	}
	setAllowsLinkPreview (allowsLinkPreview) {
		return this._object.setAllowsLinkPreview(allowsLinkPreview);
	}
	getBlacklistedURLs () {
		return this._object.getBlacklistedURLs();
	}
	setBlacklistedURLs (blacklistedURLs) {
		return this._object.setBlacklistedURLs(blacklistedURLs);
	}
	getDisableBounce () {
	...
	getDisableContextMenu () {
		return this._object.getDisableContextMenu();
	}
	setDisableContextMenu (disableContextMenu) {
		return this._object.setDisableContextMenu(disableContextMenu);
	}
	getEnableJavascriptInterface () {
		return this._object.getEnableJavascriptInterface();
	}
	setEnableJavascriptInterface (enableJavascriptInterface) {
		return this._object.setEnableJavascriptInterface(enableJavascriptInterface);
	}
	getHandlePlatformUrl () {
		return this._object.getHandlePlatformUrl();
	}
	setHandlePlatformUrl (handlePlatformUrl) {
		return this._object.setHandlePlatformUrl(handlePlatformUrl);
	}
	getHideLoadIndicator () {
		return this._object.getHideLoadIndicator();
	}
	setHideLoadIndicator (hideLoadIndicator) {
		return this._object.setHideLoadIndicator(hideLoadIndicator);
	}
	getKeyboardDisplayRequiresUserAction () {
		return this._object.getKeyboardDisplayRequiresUserAction();
	}
	setKeyboardDisplayRequiresUserAction (keyboardDisplayRequiresUserAction) {
		return this._object.setKeyboardDisplayRequiresUserAction(keyboardDisplayRequiresUserAction);
	}
	getIgnoreSslError () {
		return this._object.getIgnoreSslError();
	}
	setIgnoreSslError (ignoreSslError) {
		return this._object.setIgnoreSslError(ignoreSslError);
	}
	getOnCreateWindow () {
		return this._object.getOnCreateWindow();
	}
	setOnCreateWindow (onCreateWindow) {
		return this._object.setOnCreateWindow(onCreateWindow);
	}
	getOverScrollMode () {
	...
	getCacheMode () {
		return this._object.getCacheMode();
	}
	setCacheMode (cacheMode) {
		return this._object.setCacheMode(cacheMode);
	}
	getPluginState () {
		return this._object.getPluginState();
	}
	setPluginState (pluginState) {
		return this._object.setPluginState(pluginState);
	}
	getScrollsToTop () {
	...
	getEnableZoomControls () {
		return this._object.getEnableZoomControls();
	}
	setEnableZoomControls (enableZoomControls) {
		return this._object.setEnableZoomControls(enableZoomControls);
	}
	getScalesPageToFit () {
		return this._object.getScalesPageToFit();
	}
	setScalesPageToFit (scalesPageToFit) {
		return this._object.setScalesPageToFit(scalesPageToFit);
	}
	getUserAgent () {
	...
	getWillHandleTouches () {
		return this._object.getWillHandleTouches();
	}
	setWillHandleTouches (willHandleTouches) {
		return this._object.setWillHandleTouches(willHandleTouches);
	}
	getLightTouchEnabled () {
		return this._object.getLightTouchEnabled();
	}
	setLightTouchEnabled (lightTouchEnabled) {
		return this._object.setLightTouchEnabled(lightTouchEnabled);
	}
	getRequestHeaders () {
		return this._object.getRequestHeaders();
	}
	setRequestHeaders (requestHeaders) {
		requestHeaders = normalize(requestHeaders);
		return this._object.setRequestHeaders(requestHeaders);
	}
	getData () {
		return new Blob(this._object.getData());
	}
	setData (data) {
		data = normalize(data);
	...
	setLoading (loading) {
		return this._object.setLoading(loading);
	}
	getUrl () {
