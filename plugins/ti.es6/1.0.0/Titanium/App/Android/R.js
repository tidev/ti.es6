...
export default class R {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.App.Android.R')) {
			this._object = object;
		} else {
	...
	// constants
	static get apiName () {
		return Titanium.App.Android.R.apiName;
	}
	...
	static get bubbleParent () {
		return Titanium.App.Android.R.bubbleParent;
	}
	static set bubbleParent (value) {
		Titanium.App.Android.R.bubbleParent = value;
	}
