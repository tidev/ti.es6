...
export default class CharacterData {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.XML.CharacterData')) {
			this._object = object;
		} else {
	...
	// constants
	static get apiName () {
		return Titanium.XML.CharacterData.apiName;
	}
	static get ATTRIBUTE_NODE () {
		return Titanium.XML.CharacterData.ATTRIBUTE_NODE;
	}
	static get CDATA_SECTION_NODE () {
		return Titanium.XML.CharacterData.CDATA_SECTION_NODE;
	}
	static get COMMENT_NODE () {
		return Titanium.XML.CharacterData.COMMENT_NODE;
	}
	static get DOCUMENT_FRAGMENT_NODE () {
		return Titanium.XML.CharacterData.DOCUMENT_FRAGMENT_NODE;
	}
	static get DOCUMENT_NODE () {
		return Titanium.XML.CharacterData.DOCUMENT_NODE;
	}
	static get DOCUMENT_TYPE_NODE () {
		return Titanium.XML.CharacterData.DOCUMENT_TYPE_NODE;
	}
	static get ELEMENT_NODE () {
		return Titanium.XML.CharacterData.ELEMENT_NODE;
	}
	static get ENTITY_NODE () {
		return Titanium.XML.CharacterData.ENTITY_NODE;
	}
	static get ENTITY_REFERENCE_NODE () {
		return Titanium.XML.CharacterData.ENTITY_REFERENCE_NODE;
	}
	static get NOTATION_NODE () {
		return Titanium.XML.CharacterData.NOTATION_NODE;
	}
	static get PROCESSING_INSTRUCTION_NODE () {
		return Titanium.XML.CharacterData.PROCESSING_INSTRUCTION_NODE;
	}
	static get TEXT_NODE () {
		return Titanium.XML.CharacterData.TEXT_NODE;
	}
	static get nodeName () {
		return Titanium.XML.CharacterData.nodeName;
	}
	static get nodeType () {
		return Titanium.XML.CharacterData.nodeType;
	}
	static get parentNode () {
		return new Node(Titanium.XML.CharacterData.parentNode);
	}
	static get childNodes () {
		return new NodeList(Titanium.XML.CharacterData.childNodes);
	}
	static get firstChild () {
		return new Node(Titanium.XML.CharacterData.firstChild);
	}
	static get lastChild () {
		return new Node(Titanium.XML.CharacterData.lastChild);
	}
	static get previousSibling () {
		return new Node(Titanium.XML.CharacterData.previousSibling);
	}
	static get nextSibling () {
		return new Node(Titanium.XML.CharacterData.nextSibling);
	}
	static get attributes () {
		return new NamedNodeMap(Titanium.XML.CharacterData.attributes);
	}
	static get ownerDocument () {
		return new Document(Titanium.XML.CharacterData.ownerDocument);
	}
	static get namespaceURI () {
		return Titanium.XML.CharacterData.namespaceURI;
	}
	static get text () {
		return Titanium.XML.CharacterData.text;
	}
	static get textContent () {
		return Titanium.XML.CharacterData.textContent;
	}
	static get length () {
		return Titanium.XML.CharacterData.length;
	}
