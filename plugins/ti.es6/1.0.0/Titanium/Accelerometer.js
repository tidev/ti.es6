...
export default class Accelerometer {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.Accelerometer')) {
			this._object = object;
		} else {
	...
	// constants
	static get apiName () {
		return Titanium.Accelerometer.apiName;
	}
	...
	static get bubbleParent () {
		return Titanium.Accelerometer.bubbleParent;
	}
	static set bubbleParent (value) {
		Titanium.Accelerometer.bubbleParent = value;
	}
