...
export default class View {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.View')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.View.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.View.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.View.rect;
	}
	static get size () {
		return Titanium.UI.View.size;
	}
	static get children () {
		return Titanium.UI.View.children;
	}
