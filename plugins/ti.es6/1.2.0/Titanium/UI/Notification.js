...
export default class Notification {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.Notification')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createNotification(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.Notification.apiName;
	}
	static get rect () {
		return Titanium.UI.Notification.rect;
	}
	static get size () {
		return Titanium.UI.Notification.size;
	}
	static get children () {
		return Titanium.UI.Notification.children;
	}
	...
	get gravity () {
		return this._object.gravity;
	}
	set gravity (value) {
		this._object.gravity = value;
	}
	get xOffset () {
		return this._object.xOffset;
	}
	set xOffset (value) {
		this._object.xOffset = value;
	}
	get yOffset () {
		return this._object.yOffset;
	}
	set yOffset (value) {
		this._object.yOffset = value;
	}
	get horizontalMargin () {
		return this._object.horizontalMargin;
	}
	set horizontalMargin (value) {
		this._object.horizontalMargin = value;
	}
	get verticalMargin () {
		return this._object.verticalMargin;
	}
	set verticalMargin (value) {
		this._object.verticalMargin = value;
	}
	get message () {
	...
	getGravity () {
		return this._object.getGravity();
	}
	setGravity (gravity) {
		return this._object.setGravity(gravity);
	}
	getXOffset () {
		return this._object.getXOffset();
	}
	setXOffset (xOffset) {
		return this._object.setXOffset(xOffset);
	}
	getYOffset () {
		return this._object.getYOffset();
	}
	setYOffset (yOffset) {
		return this._object.setYOffset(yOffset);
	}
	getHorizontalMargin () {
		return this._object.getHorizontalMargin();
	}
	setHorizontalMargin (horizontalMargin) {
		return this._object.setHorizontalMargin(horizontalMargin);
	}
	getVerticalMargin () {
		return this._object.getVerticalMargin();
	}
	setVerticalMargin (verticalMargin) {
		return this._object.setVerticalMargin(verticalMargin);
	}
	getMessage () {
