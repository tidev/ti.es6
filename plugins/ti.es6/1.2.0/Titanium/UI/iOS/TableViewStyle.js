export default class TableViewStyle {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.TableViewStyle')) {
			this._object = object;
		} else {
	...
	// constants
	static get apiName () {
		return Titanium.UI.iOS.TableViewStyle.apiName;
	}
	static get GROUPED () {
		return Titanium.UI.iOS.TableViewStyle.GROUPED;
	}
	static get PLAIN () {
		return Titanium.UI.iOS.TableViewStyle.PLAIN;
	}
	...
	static get bubbleParent () {
		return Titanium.UI.iOS.TableViewStyle.bubbleParent;
	}
	static set bubbleParent (value) {
		Titanium.UI.iOS.TableViewStyle.bubbleParent = value;
	}
