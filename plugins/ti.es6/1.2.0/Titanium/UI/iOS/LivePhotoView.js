...
import { default as LivePhoto } from './LivePhoto';
import { default as Blob } from './../../Blob';
import { default as View } from './../View';

export default class LivePhotoView {

	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.iOS.LivePhotoView')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.iOS.createLivePhotoView(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.iOS.LivePhotoView.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.iOS.LivePhotoView.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.iOS.LivePhotoView.rect;
	}
	static get size () {
		return Titanium.UI.iOS.LivePhotoView.size;
	}
	static get children () {
		return Titanium.UI.iOS.LivePhotoView.children;
	}
	...
	get livePhoto () {
		return new LivePhoto(this._object.livePhoto);
	}
	set livePhoto (value) {
		this._object.livePhoto = value;
	}
	get muted () {
		return this._object.muted;
	}
	set muted (value) {
		this._object.muted = value;
	}
	...
	startPlaybackWithStyle (playbackStyle) {
		return this._object.startPlaybackWithStyle(playbackStyle);
	}
	stopPlayback () {
		return this._object.stopPlayback();
	}
	getApiName () {
	...
	getLivePhoto () {
		return new LivePhoto(this._object.getLivePhoto());
	}
	setLivePhoto (livePhoto) {
		livePhoto = normalize(livePhoto);
		return this._object.setLivePhoto(livePhoto);
	}
	getMuted () {
		return this._object.getMuted();
	}
	setMuted (muted) {
		return this._object.setMuted(muted);
	}

	// modules
};
Object.freeze(LivePhotoView);
