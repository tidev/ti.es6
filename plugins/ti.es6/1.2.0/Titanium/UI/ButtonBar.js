...
export default class ButtonBar {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.ButtonBar')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createButtonBar(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.ButtonBar.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.ButtonBar.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.ButtonBar.rect;
	}
	static get size () {
		return Titanium.UI.ButtonBar.size;
	}
	static get children () {
		return Titanium.UI.ButtonBar.children;
	}
