...
export default class TableViewRow {

	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.TableViewRow')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createTableViewRow(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.TableViewRow.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.TableViewRow.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.TableViewRow.rect;
	}
	static get size () {
		return Titanium.UI.TableViewRow.size;
	}
	static get children () {
		return Titanium.UI.TableViewRow.children;
	}
	...
	get deleteButtonTitle () {
		return this._object.deleteButtonTitle;
	}
	set deleteButtonTitle (value) {
		this._object.deleteButtonTitle = value;
	}
	get editable () {
	...
	get footer () {
		return this._object.footer;
	}
	set footer (value) {
		this._object.footer = value;
	}
	get hasDetail () {
		return this._object.hasDetail;
	}
	set hasDetail (value) {
		this._object.hasDetail = value;
	}
	get header () {
		return this._object.header;
	}
	set header (value) {
		this._object.header = value;
	}
	get indentionLevel () {
		return this._object.indentionLevel;
	}
	set indentionLevel (value) {
		this._object.indentionLevel = value;
	}
	get leftImage () {
		return this._object.leftImage;
	}
	set leftImage (value) {
		this._object.leftImage = value;
	}
	get moveable () {
	...
	get rightImage () {
		return this._object.rightImage;
	}
	set rightImage (value) {
		this._object.rightImage = value;
	}
	...
	get hasCheck () {
		return this._object.hasCheck;
	}
	set hasCheck (value) {
		this._object.hasCheck = value;
	}
	get hasChild () {
		return this._object.hasChild;
	}
	set hasChild (value) {
		this._object.hasChild = value;
	}
	get title () {
	...
	getDeleteButtonTitle () {
		return this._object.getDeleteButtonTitle();
	}
	setDeleteButtonTitle (deleteButtonTitle) {
		return this._object.setDeleteButtonTitle(deleteButtonTitle);
	}
	getEditable () {
	...
	getFooter () {
		return this._object.getFooter();
	}
	setFooter (footer) {
		return this._object.setFooter(footer);
	}
	getHasDetail () {
		return this._object.getHasDetail();
	}
	setHasDetail (hasDetail) {
		return this._object.setHasDetail(hasDetail);
	}
	getHeader () {
		return this._object.getHeader();
	}
	setHeader (header) {
		return this._object.setHeader(header);
	}
	getIndentionLevel () {
		return this._object.getIndentionLevel();
	}
	setIndentionLevel (indentionLevel) {
		return this._object.setIndentionLevel(indentionLevel);
	}
	getLeftImage () {
		return this._object.getLeftImage();
	}
	setLeftImage (leftImage) {
		return this._object.setLeftImage(leftImage);
	}
	getMoveable () {
	...
	getRightImage () {
		return this._object.getRightImage();
	}
	setRightImage (rightImage) {
		return this._object.setRightImage(rightImage);
	}
	getSelectedBackgroundColor () {
		return this._object.getSelectedBackgroundColor();
	}
	setSelectedBackgroundColor (selectedBackgroundColor) {
		return this._object.setSelectedBackgroundColor(selectedBackgroundColor);
	}
	getSelectedBackgroundImage () {
		return this._object.getSelectedBackgroundImage();
	}
	setSelectedBackgroundImage (selectedBackgroundImage) {
		return this._object.setSelectedBackgroundImage(selectedBackgroundImage);
	}
	getSelectedColor () {
	...
	getSelectionStyle () {
		return this._object.getSelectionStyle();
	}
	setSelectionStyle (selectionStyle) {
		return this._object.setSelectionStyle(selectionStyle);
	}
	getColor () {
	...
	getHasCheck () {
		return this._object.getHasCheck();
	}
	setHasCheck (hasCheck) {
		return this._object.setHasCheck(hasCheck);
	}
	getHasChild () {
		return this._object.getHasChild();
	}
	setHasChild (hasChild) {
		return this._object.setHasChild(hasChild);
	}
	getTitle () {
