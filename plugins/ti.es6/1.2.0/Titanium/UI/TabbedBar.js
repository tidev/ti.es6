...
export default class TabbedBar {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.TabbedBar')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createTabbedBar(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.TabbedBar.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.TabbedBar.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.TabbedBar.rect;
	}
	static get size () {
		return Titanium.UI.TabbedBar.size;
	}
	static get children () {
		return Titanium.UI.TabbedBar.children;
	}
