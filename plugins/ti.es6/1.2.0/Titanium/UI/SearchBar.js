...
export default class SearchBar {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.UI.SearchBar')) {
			this._object = object;
		} else {
			this._object = Titanium.UI.createSearchBar(normalize(object));
		}
	}

	// constants
	static get apiName () {
		return Titanium.UI.SearchBar.apiName;
	}
	static get animatedCenter () {
		return Titanium.UI.SearchBar.animatedCenter;
	}
	static get rect () {
		return Titanium.UI.SearchBar.rect;
	}
	static get size () {
		return Titanium.UI.SearchBar.size;
	}
	static get children () {
		return Titanium.UI.SearchBar.children;
	}
	...
	get cancelButtonTitle () {
		return this._object.cancelButtonTitle;
	}
	set cancelButtonTitle (value) {
		this._object.cancelButtonTitle = value;
	}
	get keyboardType () {
	...
	get prompt () {
		return this._object.prompt;
	}
	set prompt (value) {
		this._object.prompt = value;
	}
	get promptid () {
		return this._object.promptid;
	}
	set promptid (value) {
		this._object.promptid = value;
	}
	get showBookmark () {
		return this._object.showBookmark;
	}
	set showBookmark (value) {
		this._object.showBookmark = value;
	}
	get style () {
	...
	get showCancel () {
		return this._object.showCancel;
	}
	set showCancel (value) {
		this._object.showCancel = value;
	}
	get value () {
	...
	setShowCancel (showCancel, animated) {
		animated = normalize(animated);
		return this._object.setShowCancel(showCancel, animated);
	}
	getApiName () {
	...
	getCancelButtonTitle () {
		return this._object.getCancelButtonTitle();
	}
	setCancelButtonTitle (cancelButtonTitle) {
		return this._object.setCancelButtonTitle(cancelButtonTitle);
	}
	getKeyboardType () {
	...
	getPrompt () {
		return this._object.getPrompt();
	}
	setPrompt (prompt) {
		return this._object.setPrompt(prompt);
	}
	getPromptid () {
		return this._object.getPromptid();
	}
	setPromptid (promptid) {
		return this._object.setPromptid(promptid);
	}
	getShowBookmark () {
		return this._object.getShowBookmark();
	}
	setShowBookmark (showBookmark) {
		return this._object.setShowBookmark(showBookmark);
	}
	getStyle () {
	...
	getShowCancel () {
		return this._object.getShowCancel();
	}
	setShowCancel (showCancel) {
		return this._object.setShowCancel(showCancel);
	}
	getValue () {
