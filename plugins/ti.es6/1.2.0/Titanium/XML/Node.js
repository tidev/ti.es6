...
export default class Node {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.XML.Node')) {
			this._object = object;
		} else {
	...
	// constants
	static get apiName () {
		return Titanium.XML.Node.apiName;
	}
	...
	static get nodeName () {
		return Titanium.XML.Node.nodeName;
	}
	static get nodeType () {
		return Titanium.XML.Node.nodeType;
	}
	static get parentNode () {
		return new Node(Titanium.XML.Node.parentNode);
	}
	static get childNodes () {
		return new NodeList(Titanium.XML.Node.childNodes);
	}
	static get firstChild () {
		return new Node(Titanium.XML.Node.firstChild);
	}
	static get lastChild () {
		return new Node(Titanium.XML.Node.lastChild);
	}
	static get previousSibling () {
		return new Node(Titanium.XML.Node.previousSibling);
	}
	static get nextSibling () {
		return new Node(Titanium.XML.Node.nextSibling);
	}
	static get attributes () {
		return new NamedNodeMap(Titanium.XML.Node.attributes);
	}
	static get ownerDocument () {
		return new Document(Titanium.XML.Node.ownerDocument);
	}
	static get namespaceURI () {
		return Titanium.XML.Node.namespaceURI;
	}
	static get text () {
		return Titanium.XML.Node.text;
	}
	static get textContent () {
		return Titanium.XML.Node.textContent;
	}
