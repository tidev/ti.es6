...
export default class Calendar {
	...
	constructor (object) {
		if (object && object.apiName && object.apiName.endsWith('.Calendar.Calendar')) {
			this._object = object;
		} else {
	...
	// constants
	static get apiName () {
		return Titanium.Calendar.Calendar.apiName;
	}
	static get hidden () {
		return Titanium.Calendar.Calendar.hidden;
	}
	static get id () {
		return Titanium.Calendar.Calendar.id;
	}
	static get name () {
		return Titanium.Calendar.Calendar.name;
	}
	static get selected () {
		return Titanium.Calendar.Calendar.selected;
	}
	static get sourceTitle () {
		return Titanium.Calendar.Calendar.sourceTitle;
	}
	static get sourceType () {
		return Titanium.Calendar.Calendar.sourceType;
	}
	static get sourceIdentifier () {
		return Titanium.Calendar.Calendar.sourceIdentifier;
	}
	...
	get sourceTitle () {
		return this._object.sourceTitle;
	}
	get sourceType () {
		return this._object.sourceType;
	}
	get sourceIdentifier () {
		return this._object.sourceIdentifier;
	}
	...
	getSourceTitle () {
		return this._object.getSourceTitle();
	}
	getSourceType () {
		return this._object.getSourceType();
	}
	getSourceIdentifier () {
		return this._object.getSourceIdentifier();
	}
